...
export const V2_WRITING_BRIEF =
  ...
  "UNE SEULE IMAGE, TENUE DU DÉBUT À LA FIN (règle éliminatoire : c'est elle qui décide si on comprend ou pas). Tu choisis UNE comparaison pour toute la vidéo et tu n'en introduis JAMAIS une deuxième. Un script qui parle d'un frein, puis d'un moteur de fusée, puis d'un chef d'orchestre, puis de câbles blindés, puis d'un bolide oblige le spectateur à repartir de zéro cinq fois : il décroche même si chaque mot est simple.\n" +
  "LA PREMIÈRE FOIS, L'IMAGE EST COLLÉE À LA CHOSE RÉELLE, dans la même phrase. Jamais « la zone qui sait appuyer sur le frein » lancée comme si on savait déjà de quoi on parle. On dit d'abord ce que c'est et où c'est, puis à quoi ça ressemble : « Juste derrière ton front, une zone met des années à finir de se construire. C'est elle qui freine. »\n" +
  "ENSUITE LES MÊMES MOTS REVIENNENT : si tu l'as appelée « le frein », c'est « le frein » jusqu'à la fin, jamais « le blindage » ni « le chef d'orchestre » trois phrases plus loin. Une chose = un nom, du début à la fin.\n" +
  ...
  "LE SUJET DE CHAQUE PHRASE EST UNE CHOSE QU'ON PEUT VOIR — toi, ton cerveau, cette zone, le fil, le produit chimique. Jamais une abstraction qui agit toute seule (« le cerveau humain se construit d'arrière en avant », « ce système de contrôle », « ce blindage ») : personne ne peut se la représenter.\n" +
  "UN SEUL MOT TECHNIQUE PAR VIDÉO, ET MIEUX VAUT ZÉRO : si l'image suffit (« la zone juste derrière ton front »), tu n'as pas besoin de son nom savant.\n" +
  "DEUX SCRIPTS DE LA CHAÎNE, À RELIRE AVANT D'ÉCRIRE. Celui qui MARCHE : « Ton cerveau coupe exprès tes muscles. Pendant ton sommeil, ta zone motrice s'allume comme pour sprinter. Elle tire des décharges à fond, mais le fil est coupé juste sous ta nuque. Dans ta tête, tu donnes l'ordre de courir. Mais aucun signal n'arrive à tes jambes. » — une seule image, le fil coupé, et chaque phrase reprend un mot de la précédente. Celui qui RATE : « la zone qui sait appuyer sur le frein »… « un moteur de fusée surpuissant »… « le chef d'orchestre »… « une couche de graisse blanche autour de chaque câble »… « ce blindage »… « un bolide avec des freins en plein montage » — cinq images pour une seule idée, le spectateur ne sait plus de quoi on parle.\n" +
