...
/**
 * Consignes d'écriture ajoutées au prompt v1 pour le style papier v2, PARTIE
 * COMMUNE à toutes les formes d'histoire.
 *
 * Les règles d'accroche, de personne, de déroulé et de chute ne sont PAS ici :
 * elles dépendent de la forme d'histoire choisie pour le sujet et sont
 * produites par `storyStyleBrief()` dans `story-styles.ts`, qui est placé en
 * tête de ce bloc. C'est ce qui empêche deux vidéos de suite de se ressembler.
 */
export const V2_WRITING_BRIEF_COMMON =
  ...
  "UN OU DEUX MOTS PRÉCIS PAR VIDÉO, PAS PLUS — ET PAS ZÉRO : le nom exact d'une chose (trichobothries, pyrocumulonimbus, Hisarlik, lymphocytes T) est ce qui donne à la vidéo sa valeur et son sérieux. Tu le nommes, tu l'expliques en une incise de quelques mots à l'intérieur de la phrase, et tu continues. INTERDIT dans l'autre sens : consacrer une phrase entière à expliquer un mot, ou remplacer un terme précis par une périphrase enfantine qui tourne autour. Trop de simplification fait autant décrocher que trop de jargon.\n" +
  "LES DEUX SCRIPTS DE RÉFÉRENCE DE LA CHAÎNE, À RELIRE AVANT D'ÉCRIRE.\n" +
  "• Quand l'histoire parle du spectateur : « Ton cerveau coupe exprès tes muscles. Pendant ton sommeil, ta zone motrice s'allume comme pour sprinter. Elle tire des décharges à fond, mais le fil est coupé juste sous ta nuque. Dans ta tête, tu donnes l'ordre de courir. Mais aucun signal n'arrive à tes jambes. » — une seule chose montrée (le fil coupé, qu'on peut dessiner), chaque phrase reprend un mot de la précédente, et tout part d'une sensation que le spectateur connaît.\n" +
  "• Quand l'histoire ne parle pas de lui, et c'est le cas le plus fréquent : « Le Cyclope de l'Odyssée a une origine bien réelle. Les Grecs avaient des preuves : de vrais crânes géants percés d'un trou unique. Dans des grottes de Sicile, ils déterraient des crânes énormes, deux fois plus gros qu'un crâne humain. Et en plein centre du front, un seul trou, immense, rond, un œil unique. Pour eux, aucun doute : des géants vivaient sur cette île. Le Cyclope était né. Sauf que des siècles plus tard, les scientifiques ont identifié ces crânes. Des éléphants nains, hauts comme un mouton. Et le trou au milieu du front ? Pas un œil. La cavité de leur trompe. » — zéro « tu », des phrases longues enchaînées, une relance en question, une réponse nominale, et une chute qui recadre.\n" +
