...
export const V2_WRITING_BRIEF =
  "TEMPS DU RÉCIT, décidé par le sujet (cette règle prime sur le style narratif) : un fait passé — histoire, mythe, invention, découverte, catastrophe — se raconte AU PASSÉ (passé composé et imparfait), jamais au présent ; un mécanisme encore vrai aujourd'hui — corps, nature, physique, habitude — se raconte AU PRÉSENT. On ne mélange pas les deux dans une même partie du récit.\n" +
