...
export const V2_WRITING_BRIEF =
  ...
  "INTERDIT : LES COMPARAISONS MÉCANIQUES. Un frein, un moteur, un chef d'orchestre, un blindage, un interrupteur, un ordinateur, un disque dur : ça n'explique rien, parce que personne ne peut se représenter un frein à l'intérieur d'une tête. « La zone qui sait appuyer sur le frein » ne veut rien dire. TEST À APPLIQUER : si le plan en papier découpé ne peut pas montrer l'image telle quelle, elle est mauvaise — tu la supprimes, tu ne la remplaces pas par une autre comparaison.\n" +
  "À LA PLACE, L'IMAGE EST UN MOMENT QUE LE SPECTATEUR A VÉCU. Avant d'écrire, tu cherches LE moment de sa vie où le phénomène s'est produit, et tu le racontes comme une scène ; l'explication vient se coller dessus, jamais l'inverse. Pour « ton cerveau n'est pas fini à vingt ans » : le moment, c'est le message envoyé à deux heures du matin, et le « c'était con » qui n'arrive que le lendemain matin. Pour « tu ne peux pas courir dans tes rêves » : le moment, c'est les jambes en plomb quand quelqu'un te poursuit. On part de là, toujours, et on y revient à la fin.\n" +
