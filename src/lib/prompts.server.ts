...
export const TOPIC_INTRIGUE = [
  ...
  "Les sujets ne sont NI des anecdotes, NI des faits obscurs, NI des « idées reçues » dont le spectateur se fiche. Un bon sujet est une chose que le spectateur PORTE EN LUI (son corps, sa tête, sa mémoire, ses peurs, sa mort, son temps, ses amours) ou qui lui DONNE LE VERTIGE (la conscience, l'univers, la mort, l'infini) — et dont la vraie explication est plus étrange que ce qu'il croyait.",
  "CINQ FAMILLES, ET RIEN D'AUTRE — les deux premières en priorité :",
  "1. TOI — ce qui se passe dans ton corps et ta tête sans que tu le saches : ton cerveau décide avant toi, tu oublies exprès, chaque souvenir que tu rappelles se réécrit, tu peux avoir mal à une jambe que tu n'as plus, tu es aveugle plusieurs fois par seconde, le cœur brisé est une vraie maladie.",
  "2. LE VERTIGE — l'idée qu'on ne peut plus désapprendre : tu ne vivras peut-être jamais ta propre mort, ta tête vieillit plus vite que tes pieds, ton cerveau refuse de croire que tu vas mourir, dans dix ans la plupart de tes cellules d'aujourd'hui auront disparu.",
  "3. LES QUESTIONS DU QUOTIDIEN : pourquoi le temps passe plus vite en vieillissant, pourquoi on rêve, pourquoi on a des frissons, pourquoi les feuilles changent de couleur.",
  "4. LES GRANDS ÉPISODES D'HISTOIRE que tout le monde a entendus sans jamais comprendre, racontés par ce que des gens y ont vécu : Tchernobyl, Waterloo, la peste noire.",
  "5. LES MYTHES ET FICTIONS CONNUS DE TOUS, dont l'origine réelle surprend : le Cyclope, Troie, le talon d'Achille, Spider-Man qui arrête un train.",
  "TEST « ET ALORS ? » (éliminatoire) : après la première phrase, si le spectateur peut répondre « et alors ? » sans que ça change quelque chose pour lui — dans sa vie, son corps, sa façon de voir le monde — le sujet est refusé. Exemples refusés : les Vikings n'avaient pas de cornes, la Grande Muraille n'est pas visible de l'espace, le poisson rouge n'a pas une mémoire de trois secondes, Marie-Antoinette n'a jamais dit « qu'ils mangent de la brioche » — c'est vrai, et tout le monde s'en fiche.",
  ...
  "TEST DE VALIDATION, à appliquer avant de répondre : qu'est-ce que le spectateur croit sans même y penser (« je décide, puis j'agis », « ma mémoire est une vidéo », « la douleur vient de la blessure ») ? Si tu ne peux pas nommer cette croyance implicite, et dire en quoi elle est fausse ou incomplète, le sujet est refusé.",
...
export const TOPIC_VIRAL = [
  ...
  "",
  "LE SUJET APPARTIENT OBLIGATOIREMENT À L'UNE DES CINQ FAMILLES VALIDÉES (toi · le vertige · questions du quotidien · grands épisodes d'histoire · mythes et fictions), les deux premières en priorité. Aucun sujet hors de ces cinq familles.",
  "Dans les cinq familles, on part TOUJOURS de la réponse commune que le spectateur a déjà en tête, et on montre qu'elle est fausse ou incomplète, puis on déroule le vrai mécanisme étape par étape.",
