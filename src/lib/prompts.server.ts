...
export function scriptSystemPrompt(
  ...
  return [
    ...
    "IMPORTANT — longueur : la scène 1 est courte (1-2 phrases). Les scènes suivantes font 3 à 5 phrases (40 à 70 mots). Le script complet tient entre 45 et 90 secondes de lecture à voix haute.",
