...
export type Script = {
  ...
  /** Forme d'histoire imposée au script (papier v2) : voir `story-styles.ts`. */
  v2StoryStyle?: string;
...
export const TOPIC_INTRIGUE = [
  ...
  "Un bon sujet fait RESSENTIR quelque chose avant de faire apprendre : de la peur, de la tendresse, du vertige, de la nostalgie, du soulagement, de la fierté. Il parle du spectateur lui-même, des gens qu'il aime, de ce qu'il a vu mille fois sans comprendre, ou de quelqu'un de réel qui a risqué sa vie. Les anecdotes, les faits obscurs et les « idées reçues » dont le spectateur se fiche sont refusés.",
  "SEPT FAMILLES, ET RIEN D'AUTRE — les quatre premières en priorité :",
  "1. TOI — ce que tu vis tous les jours sans savoir pourquoi : tu ne te souviens de rien avant tes trois ans, tu te souviendras toute ta vie de tes 15-25 ans, tu n'es pas fainéant le matin (ton horloge est décalée), une chanson te donne des frissons, l'odeur d'un gâteau te ramène chez ta grand-mère, tu tombes quand tu t'endors.",
  "2. CEUX QUE TU AIMES — parents, amoureux, enfants, grands-parents, animaux, ceux qu'on a perdus : à 18 ans tu as déjà vécu 90 % du temps que tu passeras avec tes parents, une partie de toi a existé dans le ventre de ta grand-mère, ta mère porte encore des cellules de toi, quand quelqu'un meurt il peut encore t'entendre, tenir la main de la personne que tu aimes fait baisser ta douleur, les corbeaux se souviennent de ton visage.",
  "3. LE VERTIGE — l'idée qu'on ne peut plus désapprendre : tu ne vivras peut-être jamais ta propre mort, ta tête vieillit plus vite que tes pieds, ton cerveau refuse de croire que tu vas mourir, dans dix ans la plupart de tes cellules d'aujourd'hui auront disparu.",
  "4. LES HISTOIRES VRAIES où quelqu'un de réel a risqué sa vie, racontées par ce que cette personne a vécu : les trois hommes descendus sous Tchernobyl, les seize rugbymen des Andes, le soldat qui a continué la guerre 29 ans après la fin, l'homme qui a survécu 133 jours sur un radeau, la petite fille qui a sauvé cent personnes du tsunami grâce à son cours de géographie.",
  "5. LA POP CULTURE que tout le monde connaît, passée au crible de la science : Spider-Man qui arrête un train, Jack et la porte du Titanic, la planète d'Interstellar où une heure vaut sept ans, le champignon de The Last of Us, le T-Rex de Jurassic Park.",
  "6. LES MYTHES ET FICTIONS dont l'origine réelle surprend : le Cyclope, Troie, le talon d'Achille, le cachalot de Moby Dick.",
  "7. LES QUESTIONS DU QUOTIDIEN et les DEBUNKS QUI CHANGENT UN COMPORTEMENT : pourquoi on rêve, pourquoi on a des frissons, quelqu'un qui se noie ne crie pas, un tsunami n'est pas une vague, les 10 000 pas sont un slogan publicitaire, la grasse matinée ne rattrape rien.",
  "TEST DE L'ÉMOTION (éliminatoire) : pour chaque sujet, nomme en un mot ce que le spectateur RESSENT à la première phrase (peur, tendresse, vertige, nostalgie, soulagement, fierté, colère). Si la seule réponse est « de la curiosité », le sujet est refusé.",
  "TEST « ET ALORS ? » (éliminatoire) : si le spectateur peut répondre « et alors ? » sans que ça change quelque chose pour lui — dans sa vie, son corps, ses proches, sa façon de voir le monde — le sujet est refusé. Exemples refusés : les Vikings n'avaient pas de cornes, la Grande Muraille n'est pas visible de l'espace, le poisson rouge n'a pas une mémoire de trois secondes, Marie-Antoinette n'a jamais dit « qu'ils mangent de la brioche » — c'est vrai, et tout le monde s'en fiche. Un debunk n'est accepté que s'il change ce que le spectateur fera (comment il surveille un enfant à la plage, comment il dort, comment il fuit un tsunami) ou ce qu'il croit sur lui-même.",
  "CRITÈRE ABSOLU : le spectateur doit comprendre le sujet SANS AUCUNE CONNAISSANCE PRÉALABLE. Un sujet qu'il faut expliquer avant de pouvoir le poser est un MAUVAIS SUJET : remplace-le.",
  "TEST DE VALIDATION : qu'est-ce que le spectateur croit sans même y penser (« il me reste des années avec mes parents », « la douleur vient de la blessure », « quelqu'un qui se noie appelle à l'aide ») ? Si tu ne peux pas nommer cette croyance implicite, et dire en quoi elle est fausse ou incomplète, le sujet est refusé.",
...
export const TOPIC_VIRAL = [
  ...
  "Les vidéos qui marchent ont toutes quelque chose à dérouler : les poils sensoriels de l'araignée expliqués un par un, le cerveau qui compte les souvenirs et pas les heures, les cellules immunitaires des super-centenaires qu'on découvre en enquêtant, la conscience qui ne peut exister que là où on survit.",
  "",
  "LE SUJET APPARTIENT OBLIGATOIREMENT À L'UNE DES SEPT FAMILLES VALIDÉES (toi · ceux que tu aimes · le vertige · histoires vraies · pop culture · mythes et fictions · quotidien et debunks utiles), les quatre premières en priorité. Aucun sujet hors de ces sept familles.",
  "Dans les sept familles, on part TOUJOURS de la réponse commune que le spectateur a déjà en tête, et on montre qu'elle est fausse ou incomplète, puis on déroule le vrai mécanisme étape par étape.",
  "• TOI : « ton cerveau décide avant toi » — croyance implicite : « je décide, puis j'agis ». Faux. On déroule l'expérience de Libet, le tiers de seconde d'avance, le droit de veto.",
  "• VERTIGE : « ta tête vieillit plus vite que tes pieds » — croyance implicite : « le temps est le même partout ». Faux. On déroule la mesure à 33 centimètres de hauteur, les satellites GPS, les dix kilomètres d'erreur par jour sans correction.",
  "• CEUX QUE TU AIMES : « à 18 ans, tu as déjà vécu 90 % du temps que tu passeras avec tes parents » — croyance implicite : « il me reste des années avec eux ». Faux. On déroule le calcul, les dix jours par an, ce qu'on en fait.",
  "• HISTOIRE VRAIE : « seize rugbymen ont survécu 72 jours dans les Andes » — croyance implicite : « on les a secourus ». Faux. On déroule la radio qui annonce l'arrêt des recherches, les dix jours de marche de deux d'entre eux.",
  "• POP CULTURE : « Jack aurait pu survivre sur la porte du Titanic » — croyance implicite : « la porte était trop petite ». Faux. On déroule le test des physiciens, le gilet sous la planche, la flottaison.",
  ...
  "- LE DEBUNK DONT ON SE FICHE : une idée reçue corrigée qui ne change rien à la vie du spectateur (voir le test « et alors ? »).",
